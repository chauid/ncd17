...
--WRITEDAY 가 NULL 일경우 '2024-12-12' 로 변경을 해보자
...
FROM FOOD F,BOOKING B
WHERE F.FOODNUM=B.FOODNUM(+);-- 이때 아무도 주문하지 않은 메뉴는 주문자가 NULL 이 나온다
