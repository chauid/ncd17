...
<script type="text/javascript">     	
     	...
     	$(function(){
     		...
     		$(document).on("click","img.mini",function(){
     			...
     			$("img.replelarge").attr("src","https://kr.object.ncloudstorage.com/bitcamp-bucket-springmvc3/shop/"+imgSrc);
     		});
     				...
     				$.each(res,function(idx,item){
     					s+=`
     					 <div class="item" style="margin-bottom:5px;">
     							<img src="https://s8iggryl8725.edge.naverncp.com/Jy5pSYRAWb/shop/\${item.photo}?type=f&w=30&h=30&faceopt=true&ttype=jpg" alt="\${item.photo}" class="mini"
		...
		<table>
			<tr>
				<td width="120"><c:forTokens var="photo" items="${dto.sphoto}"
						delims=",">
						<img
							src="https://kr.object.ncloudstorage.com/bitcamp-bucket-springmvc3/shop/${photo}"
							class="small">
				...
				<td><img src="${dto.mainPhoto}" class="large"
					onerror="this.src='../save/noimage.png'"></td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				<td colspan="2" align="center">
					...
					<button type="button" class="btn btn-sm btn-outline-secondary"
						style="width: 90px;" onclick="sangdel(${dto.num})">삭제</button> <script
